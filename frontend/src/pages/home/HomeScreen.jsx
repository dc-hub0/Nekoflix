                ...
                <div className='absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-32'>
                    ...
                    <div className='max-w-2xl'>
                        ...
                        <p className='mt-4 text-lg'>
                            chris hemsworth, jessica chastain, and more star in this action-packed thriller about a black ops mercenary on a mission to rescue an Indian crime lord's kidnapped son.
                        </p>
                    </div>
